...
class PhonemeEncoder(nn.Module):
    ...
    def forward(self, x, train=False):
        ...
        # print("\n\n")
        # print(f"Phoneme:         {list(phoneme.shape)}")
        # print(f"phoneme_mask:        {list(phoneme_mask.shape)}")
        # print(f"pitch_target:        {list(pitch_target.shape)}")
        # print(f"energy_target:       {list(energy_target.shape)}")
        # print(f"duration_target:         {list(duration_target.shape)}")
        # print(f"mel_len:         {list(mel_len.shape)}")
        # print(f"features[0]:         {list(features[0].shape)}")
        # print(f"features[1]:         {list(features[1].shape)}")
        # print(f"mask:        {list(mask.shape)}")
        # print(f"fused_features:      {list(fused_features.shape)}")
        # print(f"pitch_pred:      {list(pitch_pred.shape)}")
        # print(f"pitch_features:      {list(pitch_features.shape)}")
        # print("\n\n")
